...
import {getUserAttendances, recordUserAttendance, UserAttendance} from '@/lib/api/user/attendance';
              ...
              {isLoading ? (
                  ...
                  attendances.map((attendance) => (
                      <TableRow key={attendance.id}>
                        ...
                        }}>{parseDateTime(attendance.checkIn).format('HH:mm')}</TableCell>
                    ...
                    {facilities.map((facility) => {
                      ...
                      return (
                          ...
                          >
                            ...
                            >
                              Khoảng
                              cách: {distance < 1000 ? `${Math.round(distance)} m` : `${(distance / 1000).toFixed(2)} km`}
